...
$this->title = Yii::t('app',"Maktab o'qituvchilari");
 ?>
<div class="heros">
    <div class="container">
      <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-12">
          <div class="middle_bar_tea">
              <h4 style="color: black;"><img src="../../images/icon/teacher.ico" alt="" /><?=Yii::t('app',"Maktab o'qituvchilari")?></h4>
             <hr style="margin: 0px; margin-bottom: 5%;">
            <?=$maktab ? $maktab_item_teacher : ''?>
          </div>
        </div>
    </div>
        </div>
