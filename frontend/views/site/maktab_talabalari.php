...
$this->title = Yii::t('app',"Maktab o'quvchilari");
 ?>
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-12">
          <div class="middle_bar_tea">
              <h4 style="color: black;"><img src="../../images/icon/pupil.ico" alt="" /><?=Yii::t('app',"Maktab o'quvchilari")?></h4>
             <hr style="margin: 0px; margin-bottom: 5%;">
            <?=$maktab ? $maktab_item_pupil : ''?>
          </div>
        </div>
    </div>
        </div>
