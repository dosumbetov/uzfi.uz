...
$this->title = Yii::t('app',"Maktab passporti");
 ?>
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-12">
          <div class="middle_bar_tea">
              <h4 style="color: black;"><img src="../../images/icon/history.ico" alt="" /><?=Yii::t('app',"Maktab passporti")?></h4>
             <hr style="margin: 0px; margin-bottom: 5%;">
            <?=$maktab ? $maktab_item_passport : ''?>
          </div>
        </div>
    </div>
        </div>
