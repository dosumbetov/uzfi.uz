...
$lang = Yii::$app->language;
  foreach ($tutor_info as $tutor_info_item) {
     if ($lang == 'uz') {
        ...
        $tutor_info_talaba_royxati = $tutor_info_item->birik_talaba_royxati_uz;
      }elseif ($lang == 'en') {
        $tutor_info_name = $tutor_info_item->name_en;
        $tutor_info_biriktirilgan = $tutor_info_item->biriktirilgan_en;
        $tutor_info_talaba_royxati = $tutor_info_item->birik_talaba_royxati_en;
      }elseif ($lang == 'ru') {
        $tutor_info_name = $tutor_info_item->name_ru;
        $tutor_info_biriktirilgan = $tutor_info_item->biriktirilgan_ru;
        $tutor_info_talaba_royxati = $tutor_info_item->birik_talaba_royxati_ru;
      }
  }
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-12">
          <div class="middle_bar_tea">
              <h4 style="color: black;"><img src="../../images/icon/tutor.ico" alt="" /><?=Yii::t('app','Biriktirilgan talabalari')?></h4>
               <hr style="margin: 0px; margin-bottom: 5%;">
               <?=$tutor_info ? $tutor_info_talaba_royxati : ''?>
          </div>
        </div>
    </div>
</div>
