...
<div class="common-kafedra-form">
    ...
    <?
            ...
            $form->field($model, 'kafedra_hodim_uz')->textInput(['maxlength' => true]).
        ...
        <?
            ...
            $form->field($model, 'kafedra_hodim_ru')->textInput(['maxlength' => true]).
        ...
        <?
            ...
            $form->field($model, 'kafedra_hodim_en')->textInput(['maxlength' => true]).
    ...
    <?= $form->field($model, 'email_uz')->textInput(['maxlength' => true]) ?>
