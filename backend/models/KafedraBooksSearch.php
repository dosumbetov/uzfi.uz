...
/**
 * KafedraBooksSearch represents the model behind the search form of `backend\models\KafedraBooks`.
 */
class KafedraBooksSearch extends KafedraBooks
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'book_kafedra_oqituvchilari_id', 'number'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'book_kafedra_oqituvchilari_id' => $this->book_kafedra_oqituvchilari_id,
            'number' => $this->number,
        ]);
